...
set folder="../datasets/extracted_data_hb/"
...
color 01
echo Start file: s4_1_train_classifier.py
%python_interpreter% s4_1_train_classifier.py
echo File s4_1_train_classifier.py finished.
color
